...
//Shared_Work holds the work need to be done part1() and part2() separates the work
// half-and-half n1 and n2 are data items chunk[64] is the separation attempt.
class Shared_Work
{
public:
